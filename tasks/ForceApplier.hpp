...
#ifndef UWV_MOTION_MODEL_FORCEAPPLIER_TASK_HPP
#define UWV_MOTION_MODEL_FORCEAPPLIER_TASK_HPP

#include "uwv_motion_model/ForceApplierBase.hpp"
...
namespace uwv_motion_model {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','uwv_motion_model::ForceApplier')
     end
     \endverbatim
	...
	// Input signal from the thrusters, can be in raw(pwm), speed(rpm/Hz or V) or effort(N)
	...
	// Forces applied by each thruster in body-frame
    ...
    public:
		...
		void calcOutput(base::samples::Joints &cmd_out, base::VectorXd &forces);
         ...
         */
        ForceApplier(std::string const& name = "uwv_motion_model::ForceApplier");
